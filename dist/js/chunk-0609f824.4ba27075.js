        ...
        "6a54": function(e, t, n) {
            ...
            (function(e) {
                ...
                t["a"] = {
                    ...
                    methods: {
                        render: function() {
                            var e = encodeURI(this.url.replace(".mp4", ".zip").replace(".mkv", ".zip")),
                                t = e.lastIndexOf(".");
                    ...
                    computed: {
                        ...
                        players: function() {
                            return [{
                                ...
                                name: "mpv",
                                icon: this.$cdnpath("images/player/mpv.png"),
                                scheme: "intent:" + this.videoUrl + "#Intent;type=video/any;package=is.xyz.mpv;scheme=https;end"
                            }, {
                                name: "nPlayer",
                                ...
                                scheme: "intent:" + this.videoUrl + "#Intent;type=video/any;package=com.mxtech.videoplayer.ad;end"
                            }, {
                                name: "MXPlayer(Pro)",
                                icon: this.$cdnpath("images/player/mxplayer.png"),
                                scheme: "intent:" + this.videoUrl + "#Intent;type=video/any;package=com.mxtech.videoplayer.pro;end"
                            }]
                        },
                        getThunder: function() {
